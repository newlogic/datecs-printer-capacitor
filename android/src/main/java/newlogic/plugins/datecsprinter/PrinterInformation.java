...
public class PrinterInformation {
    ...
    PrinterInformation(byte[] data) {
        if (data == null) {
            ...
            this.mFeedLines = 90;
            if (
                this.mPrinterName.endsWith("IR Mobile Printer") ||
                this.mPrinterName.endsWith("IR Mobile Printer") ||
                this.mPrinterName.endsWith("DATECS Ltd.") ||
                this.mPrinterName.endsWith("CMP-10BT") ||
                this.mPrinterName.endsWith("CMP-10") ||
                this.mPrinterName.endsWith("CMP-10 Bluetooth") ||
            ...
            if (
                this.mPrinterName.endsWith("DPP-350") ||
                this.mPrinterName.endsWith("DPP350") ||
                this.mPrinterName.endsWith("BLM-80") ||
                this.mPrinterName.endsWith("BLM-80C") ||
            ...
            if (
                this.mPrinterName.endsWith("DPP-250") ||
                this.mPrinterName.endsWith("SM1-21") ||
                this.mPrinterName.endsWith("SM1-22") ||
                this.mPrinterName.endsWith("DPP-255") ||
